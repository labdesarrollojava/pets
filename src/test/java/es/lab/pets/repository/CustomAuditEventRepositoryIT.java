...
import es.lab.pets.config.audit.AuditEventConverter;
import es.lab.pets.domain.PersistentAuditEvent;
...
import static es.lab.pets.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
